...
# %% MESH
e = esch.Drawing(h=h, w=w, row=1, col=1)
pos = np.stack((np.random.uniform(0, h - 1, 100), np.random.uniform(0, w - 1, 100))).T[None, ...]
...
# %% ANIM MESH
e = esch.Drawing(h=h, w=w, row=1, col=1)
pos = np.stack((np.random.uniform(0, h - 1, 1000), np.random.uniform(0, w - 1, 1000))).T[None, ...]
